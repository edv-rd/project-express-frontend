...
const Bookshelf = () => {
  ...
  useEffect(() => {
    ...
    if (author) {
      fetch(`https://project-express-api-hboqolcftq-lz.a.run.app/books/author/${author}`, {
        method: 'GET',
        headers: {
      ...
      fetch(`https://project-express-api-hboqolcftq-lz.a.run.app/bookshelf/page/${page}`, {
        method: 'GET',
        headers: {
          Accept: 'application/json',
          'Content-Type': 'application/json'
